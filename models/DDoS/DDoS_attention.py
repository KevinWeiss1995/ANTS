...
from models.helpers.NN_helpers import slice_generator
from ..helpers.NN_linear import Linear
...
def _attention(
    ...
    # query:  [batch_size, num_heads, Q, c_hidden]
    # key:    [batch_size, num_heads, K, c_hidden]
    # value:  [batch_size, num_heads, V, c_hidden]
    # mask:   [batch_size, num_heads, Q, K]
    
    key = torch.swapdims(key, -2, -1)
    # key: [batch_size, num_heads, c_hidden, K]
    
    a = torch.matmul(query, key)
    # a: [batch_size, num_heads, Q, K]
    ...
    # a: [batch_size, num_heads, Q, c_hidden]
